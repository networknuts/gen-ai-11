...
# READ TOOL DESCRIPTION - WEATHER TOOL
f = open("weather_tool_description.txt","r")
weather_tool_desc = f.read()
f.close()

# READ TOOL DESCRIPTION - ORDER TOOL
f = open("order_tool_description.txt","r")
order_tool_desc = f.read()
f.close()
...
openai_tools = [
    ...
    },
    {
        "type": "function",
        "name": "get_order",
        "description": order_tool_desc,
        "parameters": {
            "type": "object",
            "properties": {
                "user_id": {
                    "type": "integer",
                    "description": "The ID of the user to get the order data for."
                },
            },
            "required": ["user_id"]
        }
